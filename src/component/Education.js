...
function Education() {
    return (
        <div className=' flex justify-center items-center  mt-36 absolute ml-6 mr-4 sm:ml-36'>
            ...
            <motion.div
                ...
                className="container mx-auto mt-8 flex flex-col gap-4"
            >
                <motion.h2
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                {/* Add more education entries with motion animations */}
