...
import mongodb from '../asset/mongodb-plain.svg'
import nodejs from '../asset/node-js.svg'
import tailwindcss from '../asset/tailwind-css.svg'
import bootstrap from '../asset/8546808_bootstrap_icon.png'
import js from '../asset/652581_code_command_develop_javascript_language_icon.png'
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 max-w-screen mt-10">
                    ...
                    {skillItem.map((skill, id) => (
                        <motion.div key={id}
                            ...
                            className="relative flex flex-col items-center justify-center rounded-full p-4 cursor-pointer overflow-hidden"
                        >
                            <motion.img
                                src={skill.icon}
                                alt={skill.name}
                                className="w-24 h-24 mb-2 text-white"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
